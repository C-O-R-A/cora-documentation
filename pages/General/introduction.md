...
CORA (Collaborative Robot Arm) is a modular cobot platform. Design your arm in the
browser, generate matching CAD and ROS 2 software automatically, build it, and run it.
...
<div class="card-grid">
  <a class="card" href="configurator.html">
